...
from baserow_dynamic_table.core.exceptions import TrashItemDoesNotExist
...
class TrashableItemType(ModelInstanceMixin, Instance, ABC):
    """
    A TrashableItemType specifies a baserow_dynamic_table_dynamic_table_dynamic_table model which can be trashed.
    """
...
class TrashableItemTypeRegistry(ModelRegistryMixin, Registry):
    """
    The TrashableItemTypeRegistry contains models which can be "trashed" in baserow_dynamic_table_dynamic_table_dynamic_table.
    When an instance of a trashable model is trashed it is removed from baserow_dynamic_table_dynamic_table_dynamic_table but
    not permanently. Once trashed an item can then be restored to add it back to
    baserow_dynamic_table_dynamic_table_dynamic_table just as it was when it was trashed.
    """
