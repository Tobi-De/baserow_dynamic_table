    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tsvector_column_created",
                    models.BooleanField(
                        default=False,
                        help_text="Indicates whether a `tsvector` has been created for this field yet. This value will be False for fields created before the full text search release which haven't been lazily migrated yet. Or for users who have turned off full text search entirely.",
                    ),
                ),
                (
                    "content_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "needs_background_update_column_added",
                    models.BooleanField(
                        default=False,
                        help_text="Indicates whether the table has had the background_update_needed column added.",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    baserow_dynamic_table.fields.fields.SerialField(),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["-trashed_at", "trash_item_type"],
                        name="baserow_dyn_trashed_96f430_idx",
                    )
                ],
            },
        ),
