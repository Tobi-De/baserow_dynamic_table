...
from baserow_dynamic_table_dynamic_table_dynamic_table.core.action.models import Action
from baserow_dynamic_table_dynamic_table_dynamic_table.core.action.registries import (
    ActionScopeStr,
    ActionTypeDescription,
    UndoableActionType,
)
from baserow_dynamic_table_dynamic_table_dynamic_table.core.action.scopes import ApplicationActionScopeType
from baserow_dynamic_table_dynamic_table_dynamic_table.core.trash.handler import TrashHandler
from baserow_dynamic_table_dynamic_table_dynamic_table.core.utils import ChildProgressBuilder, Progress
from baserow_dynamic_table.action.scopes import DATABASE_ACTION_CONTEXT
from baserow_dynamic_table.handler import DatabaseHandler
...
class DeleteTableActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, table: Table):
        ...
        Seebaserow_dynamic_table.table.handler.TableHandler.delete_table
        for further details.
...
class OrderTableActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, database: Database, order: List[int]):
        ...
        Seebaserow_dynamic_table.table.handler.TableHandler.order_table
        for further details.
...
class UpdateTableActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, table: Table, name: str) -> Table:
        """
        Updates the table.
        Seebaserow_dynamic_table.table.handler.TableHandler.update_table
        for further details.
