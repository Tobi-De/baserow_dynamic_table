...
class LockConflict(Exception):
    ...
    baserow_dynamic_table_dynamic_table_dynamic_table has been locked for some operation.
    """
...
class MaxLocksPerTransactionExceededException(Exception):
    """
    baserow_dynamic_table_dynamic_table_dynamic_table can sometimes perform operations that require a Postgres LOCK on a large
    ...
    message = (
        "baserow_dynamic_table_dynamic_table_dynamic_table has exceeded the maximum number of PostgreSQL locks per transaction. "
        "Please read https://baserow_dynamic_table_dynamic_table_dynamic_table.io/docs/technical/postgresql-locks"
    )
...
class DuplicateApplicationMaxLocksExceededException(
    ...
    message = (
        "baserow_dynamic_table_dynamic_table_dynamic_table attempted to duplicate an application, but exceeded the maximum "
        "number of PostgreSQL locks per transaction. Please read "
        "https://baserow_dynamic_table_dynamic_table_dynamic_table.io/docs/technical/postgresql-locks"
    )
